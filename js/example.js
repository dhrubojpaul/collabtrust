var Harvest = (function () {
  ...
  function startGame() {
	...
	function init() {
		...
		geometry = new THREE.BoxGeometry( 800, 0, 800 )
		...
		//for ( var i = 0; i < 1; i ++ ) {
			var i=0;
			//var wall = new THREE.Mesh( boxGeometry, items[Math.floor(Math.random()*items.length)] );
			var wall = new THREE.Mesh( new THREE.BoxGeometry( 800, 80, 20 ), items[Math.floor(Math.random()*items.length)] );
